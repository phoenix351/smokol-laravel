...
const Detail = ({ auth, barang }: { auth: any, barang: any }) => {
    ...
    return (
        <>
            ...
            <Card title="Detail Barang" bordered={false}>
                <Row>
                    ...
                    <Col className={styles.column}>
                        <Button className={styles.row}>{barang.barang.jenis}</Button>
                        <Row className={styles.row}>{barang.barang.merk} / {barang.barang.tipe}</Row>
                        <hr />
                        {
                            barang.bast_path ?
                                <Row className={styles.row}>
                                    ...
                                    <Row className={styles.row}>
                                        ...
                                        <Button className={styles.button} type="primary">Upload BAST</Button>
                                    </Row>
                                    <br></br>
                                </>
                        }
