...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        WHERE barang.barang_id = master_barang.id and barang.sistem_operasi_id = master_sistem_operasi.id and ruangan_id = master_ruangan.id and barang.pengguna_id = users.id 
